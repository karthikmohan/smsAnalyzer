...
public class AddDialog extends Dialog implements View.OnClickListener {
    ...
    public AddDialog(Context context, List<Sms> cashList) {
        ...
        Spinner description = findViewById(R.id.description);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.save:
                ...
                String t = "";
                if (type.equals("Debit") || type.equals("Food") || type.equals("Transport"))
                    t = "DR";
                else if (type.equals("Credit") || type.equals("Salary"))
                    t = "CR";
